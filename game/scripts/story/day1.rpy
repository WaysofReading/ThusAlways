label day1_backstory_cutscene:
    ...
    scene stove_and_figure with dissolve
    ...
    label day1_choice_stay_quiet:
        ...
        guide "This ends {i}_now _{/i}This horrid cycle ends _here_."
        ...
        label day1_choice_lie:
            ...
            guide "Oh for the love of -- {i}_shut up_{/i}."
    ...
    label day1_choice_answer_door:
        ...
        show lance at Position(xpos=0.5, ypos=0.55):
            zoom 0.5
        show morgan at Position(xpos=0.6, ypos=0.55):
            zoom 0.5
        show gavin at Position(xpos=0.35, ypos=0.4):
            zoom 1.0
...
label day1_combat_intro:
    ...
    "SYD: Which music track should we use here? I chose 'Frozen Landscape'"
    ...
    guide "“I {i}am{/i} saying that we’re going to have a _lot_ of work on our hands.”"
