label day0_guide_backstory:
    ...
    show gavin silhouette at linedup_center_gavin
    show lance silhouette at linedup_center_lance
    show morgan silhouette at linedup_center_morgan
    with dissolve
    ...
    call end_scene_fade_to_black from _call_end_scene_fade_to_black
