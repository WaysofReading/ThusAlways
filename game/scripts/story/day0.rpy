label day0_guide_backstory:
    ...
    ## FADE IN to misty screen; there’s no defined environment    
    scene backdrop_mist
    with fade
    ...
    guide 'I dream of that foggy, half-solid air that cloyed thick in our lungs, before it rushed out from us as we took our first tentative steps into the misty and primal unknown.'
    ...
    guide 'The mountains erupted from the earth as if molten magma bursting from a glass beaker, the oceans were a tumultuous roar that flooded both vast deserts and our ears, and the forests called to us as any great city would have, with all the same promise.'
    ...
    guide 'How could we, when we knew we brought with us the same seed of destruction that had annihilated the last world?'
